...
export default makeScene2D(function* (view) {
  ...
  const indicatorOpacity = createSignal(0);
  const titleTextOpacity = createSignal(0);
  const subTitleTextOpacity = createSignal(0);
  let yMax = 30;
  //PC
  view.add(
    <Rect>
  ...
  yield* all(
    ...
    loop(99,i => indicatorOpacity(0,0).to(100,1).to(0,0).to(100,1).to(0,0)),
    titleTextOpacity(0,1).to(100,1),
    subTitleTextOpacity(0,2).to(100,1),
